...
* `<context> <term> [more terms if you want]` (this can be disabled with ZSH_WEB_SEARCH_NO_ALIAS)

To prevent interference with programs that might have the same name as a context, the generation of aliases can be switched off 
by setting the environment variable ZSH_WEB_SEARCH_NO_ALIAS="true".
